...
scoreboard objectives add magnetic_enchantment.player.use.copper_pickaxe minecraft.used:minecraft.copper_pickaxe
...
scoreboard objectives add magnetic_enchantment.player.use.copper_axe minecraft.used:minecraft.copper_axe
...
scoreboard objectives add magnetic_enchantment.player.use.copper_shovel minecraft.used:minecraft.copper_shovel
...
scoreboard objectives add magnetic_enchantment.player.use.copper_hoe minecraft.used:minecraft.copper_hoe
