...
execute if entity @e[type=#redstone_robot:utils/hostiles,distance=..22.5] run return run function redstone_robot:redstone_robot/armor_stand/tick/mode/attack/ranged/range
