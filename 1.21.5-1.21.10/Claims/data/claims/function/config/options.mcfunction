...
execute if score list claims.config matches 1 run tellraw @s [{"color":"gray","text":"- Show Player ID in List: "},{"bold":true,"click_event":{"action":"run_command","command":"/function claims:config/options/list/disable"},"color":"green","hover_event":{"action":"show_text","value":[{"text":"Click to disable player id in list"}]},"text":"ENABLED"}]
execute if score list claims.config matches 0 run tellraw @s [{"color":"gray","text":"- Show Player ID in List: "},{"bold":true,"click_event":{"action":"run_command","command":"/function claims:config/options/list/enable"},"color":"gray","hover_event":{"action":"show_text","value":[{"text":"Click to enable player id in list"}]},"text":"DISABLED"}]
