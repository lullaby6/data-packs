execute store result score @s target_dummy.dummy.hithox.max_health run attribute @s minecraft:generic.max_health get
...
data modify entity @n[tag=target_dummy.dummy] Motion set value [0.0d,0.1d,0.0d]
