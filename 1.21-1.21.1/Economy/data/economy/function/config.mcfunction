...
function economy:config/utils/toggle {"id":"player_shops","title":"Player Shops","text":"player shops"}
...
execute if score jobs economy.config matches 1 run tellraw @s [{"text":"- ","color":"gray"},{"text":"See Jobs","color":"gray","hoverEvent":{"action":"show_text","contents":[{"text":"Click to see the jobs config"}]},"clickEvent":{"action":"run_command","value":"/function economy:config/jobs"}}]
execute if score jobs economy.config matches 1 run tellraw @s [{"text":"- ","color":"gray"},{"text":"Reset Jobs","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"Click to reset the jobs config"}]},"clickEvent":{"action":"run_command","value":"/function economy:config/command/reset/jobs"}}]

tellraw @s [{"text":"- ","color":"gray"},{"text":\
    "Delete Nearest Player Shop","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":\
    "Click to delete nearest Player Shop"}]},"clickEvent":{"action":"run_command","value":\
    "/function economy:player/shop/delete/nearest"\
}}]

tellraw @s [{"text":"- ","color":"gray"},{"text":\
    "Delete All Player Shops","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":\
    "Click to delete all Player Shop"}]},"clickEvent":{"action":"run_command","value":\
    "/function economy:player/shop/delete/all"\
}}]

tellraw @s [{"text":"- ","color":"gray"},{"text":\
    "Reset Config","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":\
    "Click to reset config"}]},"clickEvent":{"action":"run_command","value":\
