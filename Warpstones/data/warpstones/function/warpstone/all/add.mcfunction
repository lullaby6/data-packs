...
function warpstones:warpstone/all/add/custom_name with storage warpstones:all data
...
data modify storage warpstones:all warpstones append from storage warpstones:all data
