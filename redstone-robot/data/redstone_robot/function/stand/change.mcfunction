...
tag @s remove redstone_robot.robot.mode.storage.bundle
...
execute if items entity @s weapon.mainhand minecraft:bundle run return run tag @s add redstone_robot.robot.mode.storage.bundle
