...
execute if score @s economy.pay.amount > @s economy.player.balance run return run function economy:player/trigger/use/pay/amount/fail {"text":"You don't have enough balance."}
