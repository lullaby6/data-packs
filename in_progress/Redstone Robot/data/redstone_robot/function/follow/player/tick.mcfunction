...
execute if entity @a[distance=..3] run function redstone_robot:utils/entity/despawn
execute unless entity @e[tag=redstone_robot.stand,distance=..3] run function redstone_robot:utils/entity/despawn