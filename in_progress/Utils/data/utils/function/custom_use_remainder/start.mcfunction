summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,HasVisualFire:0b,ShowArms:0b,Small:1b,Invisible:1b,Tags:["utils.custom_use_remainder"],attributes:[{id:"minecraft:scale",base:0}],DisabledSlots:4144959}
