advancement revoke @s only economy:score/leave
advancement revoke @s only economy:score/kill
advancement revoke @s only economy:score/killer
...
advancement revoke @s only economy:score/trigger/jobs
advancement revoke @s only economy:score/trigger/job/join/miner
advancement revoke @s only economy:score/trigger/job/join/hunter
advancement revoke @s only economy:score/trigger/job/join/builder
...
scoreboard players reset @s economy.timer.player.killer
...
scoreboard players reset @s economy.top
...
scoreboard players reset @s economy.jobs
scoreboard players reset @s economy.job.leave
scoreboard players reset @s economy.job.join.miner
scoreboard players reset @s economy.job.join.hunter
scoreboard players reset @s economy.job.join.builder
...
trigger economy.show_id add 0
trigger economy.balance add 0
trigger economy.coin add 0
trigger economy.pay add 0
trigger economy.pay.amount add 0
trigger economy.top add 0
trigger economy.bounty add 0
trigger economy.bounty.amount add 0
