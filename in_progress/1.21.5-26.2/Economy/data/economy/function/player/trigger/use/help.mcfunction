...
tellraw @s [{"color":"gray","text":"- /trigger "},{"color":"green","text":"economy.pay"},{"color":"gray","text":" set "},{"color":"green","text":"<player_id>"},{"color":"gray","text":" - Set the Player ID you want to pay"}]
tellraw @s [{"color":"gray","text":"- /trigger "},{"color":"green","text":"economy.pay.amount"},{"color":"gray","text":" set "},{"color":"green","text":"<balance_amount>"},{"color":"gray","text":" - Set the amount to send to the selected player"}]
...
execute if score jobs economy.config matches 1 run tellraw @s [{"color":"gray","text":"- /trigger "},{"color":"green","text":"economy.job.leave"},{"color":"gray","text":" - Leave your current job"}]
