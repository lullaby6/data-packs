...
execute store result storage bossmines:utils/motion motion[0] double -0.00025 run scoreboard players get @s utils.motion.mx
execute store result storage bossmines:utils/motion motion[1] double -0.00025 run scoreboard players get @s utils.motion.my
execute store result storage bossmines:utils/motion motion[2] double -0.00025 run scoreboard players get @s utils.motion.mz