...
function bossmines:boss/ondine/skill/move/macro with storage bossmines:storage ondine

data remove storage bossmines:storage ondine

execute if entity @s[tag=bossmines.ondine.skill.move.fail] run function bossmines:boss/ondine/skill/move/calc