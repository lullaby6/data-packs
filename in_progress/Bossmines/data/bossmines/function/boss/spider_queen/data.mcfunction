...
tag @s add bossmines.entity.boss.spider_queen
...
data modify entity @s CustomName set value "Spider Queen"
...
function bossmines:utils/entity/bossbar/entity/load {"name":"Spider Queen","max":300,"color":"purple","name_color":"white","style":"progress","distance":100,bold:false}
