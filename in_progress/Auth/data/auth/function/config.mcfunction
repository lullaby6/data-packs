...
tellraw @s [{"color":"gray","text":"Version: "},{"color":"aqua","text":"v1.5.2"}]
...
tellraw @s [{"text":"- ","color":"gray"},{"text":"Reset Messages","color":"red","hover_event":{"action":"show_text","value":[{"text":"Click to reset messages"}]},"click_event":{"action":"run_command","command":"/function auth:config/commands/reset/messages"}}]
