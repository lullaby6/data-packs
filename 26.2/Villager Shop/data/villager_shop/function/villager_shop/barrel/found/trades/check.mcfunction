...
$execute if data entity @s Offers.Recipes[$(slot)] as @n[tag=villager_shop.marker] run return run function villager_shop:villager_shop/barrel/action/action {"action":"trades/remove {\"slot\":$(slot)}"}
