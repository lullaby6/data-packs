...
execute if score end_protect graves.config matches 1 unless dimension minecraft:the_end if block ~ ~-0.1 ~ air run function graves:grave/entity/interaction/prevent/air
...
execute if score water_protect graves.config matches 1 if block ~ ~ ~ water if block ~ ~-0.1 ~ water run function graves:grave/entity/interaction/prevent/water
execute if score lava_protect graves.config matches 1 if block ~ ~ ~ lava run function graves:grave/entity/interaction/prevent/lava

execute if score void_protect graves.config matches 0 run return fail
