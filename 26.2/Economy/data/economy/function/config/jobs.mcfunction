...
tellraw @s [{"text":"- ","color":"gray"},{"text":"Reset Jobs","color":"red","hover_event":{"action":"show_text","value":[{"text":"Click to reset the jobs config"}]},"click_event":{"action":"run_command","command":"/function economy:config/command/reset/jobs/page"}}]
