...
execute if score payment economy.config matches 1 run scoreboard players enable @s economy.pay
execute if score payment economy.config matches 1 if score @s economy.player.pay.player_id matches 1.. run scoreboard players enable @s economy.pay.amount
...
execute if score player_shops economy.config matches 1 if entity @s[tag=economy.player.shop_created] run scoreboard players enable @s economy.shop.remove
