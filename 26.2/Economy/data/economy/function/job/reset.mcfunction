tag @s remove economy.player.job

tag @s remove economy.player.job.miner
tag @s remove economy.player.job.hunter
tag @s remove economy.player.job.builder
tag @s remove economy.player.job.woodcutter
tag @s remove economy.player.job.digger
