$data modify storage portals:blocks portals.$(id) set value {}

loot replace entity @s armor.head mine ~ ~-1 ~ netherite_pickaxe[enchantments={"minecraft:silk_touch":1}]
$data modify storage portals:blocks portals.$(id).bottom set from entity @s ArmorItems[3].id

loot replace entity @s armor.head mine ~ ~2 ~ netherite_pickaxe[enchantments={"minecraft:silk_touch":1}]
$data modify storage portals:blocks portals.$(id).top set from entity @s ArmorItems[3].id
