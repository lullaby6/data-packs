...
item replace entity @s armor.head with leather_helmet[dyed_color=6405812,trim={material:"minecraft:diamond",pattern:"minecraft:tide"},unbreakable={},enchantments={levels:{"vanishing_curse":1}}] 1
item replace entity @s armor.chest with leather_chestplate[dyed_color=6405812,trim={material:"minecraft:diamond",pattern:"minecraft:tide"},unbreakable={},enchantments={levels:{"vanishing_curse":1}}] 1
item replace entity @s armor.legs with leather_leggings[dyed_color=6405812,trim={material:"minecraft:diamond",pattern:"minecraft:tide"},unbreakable={},enchantments={levels:{"vanishing_curse":1}}] 1
item replace entity @s armor.feet with leather_boots[dyed_color=6405812,trim={material:"minecraft:diamond",pattern:"minecraft:tide"},unbreakable={},enchantments={levels:{"vanishing_curse":1}}] 1

item replace entity @s weapon.mainhand with minecraft:trident[enchantments={levels:{"minecraft:impaling":5,"fishing_expansion:thundering":1,"vanishing_curse":1}},unbreakable={}] 1
item replace entity @s weapon.offhand with minecraft:trident[enchantments={levels:{"minecraft:impaling":5,"fishing_expansion:thundering":1,"vanishing_curse":1}},unbreakable={}] 1
