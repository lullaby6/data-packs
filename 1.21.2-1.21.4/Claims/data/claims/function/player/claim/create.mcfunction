...
execute if score @s claims.player.no_claim_zone matches 1.. run return run function claims:claim/no_claim_zone/cancel with storage claims:no_claim_zone_cancel data
