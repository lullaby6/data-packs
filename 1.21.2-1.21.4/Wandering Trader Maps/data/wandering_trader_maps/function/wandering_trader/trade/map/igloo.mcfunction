loot spawn ~ ~ ~ loot wandering_trader_maps:map/igloo
...
data modify storage wandering_trader_maps:main trade.sell set from entity @n[type=item,predicate=wandering_trader_maps:item/map/igloo,distance=..1] Item
...
kill @n[type=item,predicate=wandering_trader_maps:item/map/igloo,distance=..1]
