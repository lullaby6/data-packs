loot spawn ~ ~ ~ loot wandering_trader_maps:map/village
...
data modify storage wandering_trader_maps:main trade.sell set from entity @n[type=item,predicate=wandering_trader_maps:item/map/village,distance=..1] Item
...
kill @n[type=item,predicate=wandering_trader_maps:item/map/village,distance=..1]
