...
execute if score @s claims.player.id = @s claims.invite run return run function claims:claim/cancel/invite/not_yourself

execute store result storage claims:invite data.claim_id int 1 run scoreboard players get @s claims.player.id
