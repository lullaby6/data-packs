...
tag @s add lullaby_mobs.triple_skeleton.leader
...
item replace entity @s weapon.mainhand with bow[enchantments={"power":4}] 1
...
function lullaby_mobs:mob/triple_skeleton/clone/summon
function lullaby_mobs:mob/triple_skeleton/clone/summon