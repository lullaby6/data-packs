...
item replace entity @s armor.head with player_head[custom_name='{"translate":"Mummy"}',profile={id:[I;30324814,-124108764,-1709806701,437631414],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGEyOTM4ZGNhYmY3NTQyZjRjNzVhZDQ1Nzg0OTliZGZhMDkyOGU1NTFjMGIyMmIzOWI4YzNkMDFkYmY5MGFlMCJ9fX0="}]}] 1
