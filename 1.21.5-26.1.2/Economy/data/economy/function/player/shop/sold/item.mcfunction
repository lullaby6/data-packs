...
$data modify entity @n[tag=economy.player_shop.item.$(player_shop_id)] Item set from entity @n[tag=economy.player_shop.armor_stand,scores={economy.player_shop.id=$(player_shop_id)}] equipment.feet
