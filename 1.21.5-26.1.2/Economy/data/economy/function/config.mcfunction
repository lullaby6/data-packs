...
tellraw @s [{"text":"- ","color":"gray"},{"text":\
    "Delete Nearest Player Shop","color":"red","hover_event":{"action":"show_text","value":[{"text":\
    "Click to delete nearest Player Shop"}]},"click_event":{"action":"run_command","command":\
    "/function economy:player/shop/delete/nearest"\
}}]

tellraw @s [{"text":"- ","color":"gray"},{"text":\
    "Delete All Player Shops","color":"red","hover_event":{"action":"show_text","value":[{"text":\
    "Click to delete all Player Shop"}]},"click_event":{"action":"run_command","command":\
