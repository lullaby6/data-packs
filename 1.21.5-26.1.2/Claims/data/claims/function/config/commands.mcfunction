...
tellraw @s [{"text":"- ","color":"gray"},{"text":"Delete Nearest Claim","color":"red","hover_event":{"action":"show_text","value":[{"text":"Click to delete the nearest claim"}]},"click_event":{"action":"run_command","command":"/function claims:config/commands/delete_nearest_claim"}}]
...
tellraw @s [{"text":"- ","color":"gray"},{"text":"Reset Config","color":"red","hover_event":{"action":"show_text","value":[{"text":"Click to reset config"}]},"click_event":{"action":"run_command","command":"/function claims:config/commands/reset"}}]
