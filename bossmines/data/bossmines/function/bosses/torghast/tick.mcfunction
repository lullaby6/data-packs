...
execute if entity @s[nbt={active_effects:[{id:"minecraft:mining_fatigue",duration:200}]}] run return run function bossmines:bosses/torghast/skill/ghast/summon
...
execute if entity @s[nbt={active_effects:[{id:"minecraft:mining_fatigue",duration:1}]}] run return run function bossmines:bosses/torghast/skill/fireball