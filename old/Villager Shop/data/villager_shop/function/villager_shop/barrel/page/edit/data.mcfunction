...
function villager_shop:villager_shop/barrel/utils/loot_replace_safe {"slot":22,"loot":"villager_shop:barrel/generic/remove"}
function villager_shop:villager_shop/barrel/utils/loot_replace_safe {"slot":26,"loot":"villager_shop:barrel/generic/confirm"}

execute if predicate villager_shop:barrel/edit/loaded run return fail

data modify storage villager_shop:edit data.slot set from entity @s data."villager_shop:data"."edit_slot"
function villager_shop:villager_shop/barrel/page/edit/trade with storage villager_shop:edit data
data remove storage villager_shop:edit data