...
execute unless items block ~ ~ ~ container.11 *[minecraft:custom_data~{villager_shop.item.barrel:1b}] run return run function villager_shop:villager_shop/barrel/action/action {"action":"menu/proffesion/check"}
