execute if entity @s[tag=hammer_enchantment.player.rotation.up] if block ~ ~-1 ~ #minecraft:air run return run function hammer_enchantment:hammer/level/2/y
execute if entity @s[tag=hammer_enchantment.player.rotation.down] if block ~ ~1 ~ #minecraft:air run return run function hammer_enchantment:hammer/level/2/y
